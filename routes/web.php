...
Route::middleware(['auth','active'])->group(function () {
    ...
    Route::prefix('teacher')->name('teacher.')->middleware('teacher')->group(function () {
        ...
        Route::get('/reviews',[ReviewFeedbackController::class,'index'])->name('reviews.index'); Route::get('/reviews/{lesson}/history',[ReviewFeedbackController::class,'history'])->name('reviews.history'); Route::patch('/reviews/{lesson}/resubmit',[ReviewFeedbackController::class,'resubmit'])->name('reviews.resubmit');
    ...
    Route::prefix('admin')->name('admin.')->middleware('admin')->group(function () {
        ...
        Route::get('/reviews/history', [ModerationLogController::class, 'index'])->name('reviews.history');
