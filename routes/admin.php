...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::resource('vocabulary', VocabularyTermController::class)->parameters(['vocabulary' => 'vocabulary'])->except('show');
    ...
    Route::get('/assessments/{assessment}/questions/create', [AssessmentQuestionController::class, 'create'])->name('assessments.questions.create');
    Route::post('/assessments/{assessment}/questions', [AssessmentQuestionController::class, 'store'])->name('assessments.questions.store');
    Route::get('/assessments/{assessment}/questions/{question}/edit', [AssessmentQuestionController::class, 'edit'])->name('assessments.questions.edit');
    Route::put('/assessments/{assessment}/questions/{question}', [AssessmentQuestionController::class, 'update'])->name('assessments.questions.update');
    Route::delete('/assessments/{assessment}/questions/{question}', [AssessmentQuestionController::class, 'destroy'])->name('assessments.questions.destroy');

    Route::get('/assessment-results', [AssessmentResultController::class, 'index'])->name('assessment-results.index');
    Route::get('/assessment-results/{attempt}', [AssessmentResultController::class, 'show'])->whereNumber('attempt')->name('assessment-results.show');
