        ...
        <aside class="border-b border-slate-200 bg-white lg:min-h-screen lg:border-b-0 lg:border-r">
            ...
            <nav class="px-4 pb-5 lg:px-5" aria-label="Teacher navigation">
                ...
                <div class="flex gap-2 overflow-x-auto pb-1 lg:flex-col lg:overflow-visible">
                    ...
                    <a href="{{ route('teacher.progress.index') }}" class="flex min-w-fit items-center rounded-xl px-3 py-3 text-sm font-bold {{ request()->routeIs('teacher.progress.*') ? 'bg-slate-950 text-white' : 'text-slate-700 hover:bg-slate-100' }}">Learner Progress</a>
                    <a href="{{ route('teacher.ai.index') }}" class="flex min-w-fit items-center rounded-xl px-3 py-3 text-sm font-bold {{ request()->routeIs('teacher.ai.*') ? 'bg-slate-950 text-white' : 'text-slate-700 hover:bg-slate-100' }}">AI Assistant</a>
                    <a href="{{ route('teacher.rag.index') }}" class="flex min-w-fit items-center rounded-xl px-3 py-3 text-sm font-bold {{ request()->routeIs('teacher.rag.*') ? 'bg-slate-950 text-white' : 'text-slate-700 hover:bg-slate-100' }}">Knowledge Assistant</a>
