...
@section('title', 'Edit Question - SignGyaan Admin')
@section('page-title', 'Edit Assessment Question')
@section('description', 'Update a SignGyaan assessment question, answer options and scoring details.')
        ...
        <div class="mx-auto max-w-6xl">
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    ...
                    <h2 class="mt-2 font-heading text-3xl font-semibold text-sign-primary sm:text-4xl">Edit Question</h2>
            ...
            <form method="POST" action="{{ route('admin.assessments.questions.update', [$assessment, $question]) }}">
                @csrf
                @method('PUT')
