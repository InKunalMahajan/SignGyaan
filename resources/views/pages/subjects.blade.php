...
@section('content')
    ...
    <section class="border-b border-sign-border bg-sign-soft py-10 sm:py-14 lg:py-20">
        <x-container>
            <div class="max-w-3xl">
                <p class="text-xs font-semibold uppercase tracking-wider text-sign-cyan-dark sm:text-sm">
                    Subjects
                </p>

                <h1 class="mt-3 font-heading text-3xl font-semibold leading-tight tracking-tight text-sign-primary sm:text-5xl">
    ...
    <section class="bg-white py-10 sm:py-14 lg:py-20">
        <x-container>
            ...
            <div class="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
                ...
                <a
                    href="{{ route('learn') }}"
                    class="inline-flex min-h-11 items-center gap-2 self-start text-sm font-semibold text-sign-primary transition hover:text-sign-cyan-dark sm:self-auto"
                >
                    View learning paths
            ...
            <div class="mt-8 grid gap-4 sm:mt-10 sm:grid-cols-2 lg:grid-cols-3 lg:gap-5">
                ...
                <article class="group flex h-full flex-col rounded-2xl border border-sign-border bg-white p-5 transition duration-200 hover:-translate-y-1 hover:border-sign-cyan hover:shadow-lg sm:rounded-3xl sm:p-6">
                    <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-sign-light text-sign-primary sm:h-12 sm:w-12">
                    ...
                    <h2 class="mt-4 font-heading text-xl font-semibold text-sign-primary sm:mt-5 sm:text-2xl">English</h2>
                    <p class="mt-2 flex-1 text-sm leading-6 text-sign-muted sm:mt-3">Build vocabulary, grammar, reading and everyday communication skills.</p>
                    <a href="{{ route('subjects.show', 'english') }}" class="mt-5 inline-flex min-h-11 items-center gap-2 text-sm font-semibold text-sign-primary sm:mt-6">
                        Explore English
                ...
                <article class="group flex h-full flex-col rounded-2xl border border-sign-border bg-white p-5 transition duration-200 hover:-translate-y-1 hover:border-sign-cyan hover:shadow-lg sm:rounded-3xl sm:p-6">
                    ...
                    <h2 class="mt-4 font-heading text-xl font-semibold text-sign-primary sm:mt-5 sm:text-2xl">Mathematics</h2>
                    <p class="mt-2 flex-1 text-sm leading-6 text-sign-muted sm:mt-3">Understand numbers, money, measurements and practical calculations step by step.</p>
                    <a href="{{ route('subjects.show', 'mathematics') }}" class="mt-5 inline-flex min-h-11 items-center gap-2 text-sm font-semibold text-sign-primary sm:mt-6">
                        Explore Mathematics
                        <span class="transition group-hover:translate-x-1">→</span>
                    </a>
                </article>
                ...
                <article class="group flex h-full flex-col rounded-2xl border border-sign-border bg-white p-5 transition duration-200 hover:-translate-y-1 hover:border-sign-cyan hover:shadow-lg sm:rounded-3xl sm:p-6">
                    ...
                    <h2 class="mt-4 font-heading text-xl font-semibold text-sign-primary sm:mt-5 sm:text-2xl">Science</h2>
                    <p class="mt-2 flex-1 text-sm leading-6 text-sign-muted sm:mt-3">Explore scientific ideas with visual examples, clear explanations and simple activities.</p>
                    <a href="{{ route('subjects.show', 'science') }}" class="mt-5 inline-flex min-h-11 items-center gap-2 text-sm font-semibold text-sign-primary sm:mt-6">
                        Explore Science
                        <span class="transition group-hover:translate-x-1">→</span>
                    </a>
                </article>
                ...
                <article class="group flex h-full flex-col rounded-2xl border border-sign-border bg-white p-5 transition duration-200 hover:-translate-y-1 hover:border-sign-cyan hover:shadow-lg sm:rounded-3xl sm:p-6">
                    ...
                    <h2 class="mt-4 font-heading text-xl font-semibold text-sign-primary sm:mt-5 sm:text-2xl">Digital Skills</h2>
                    <p class="mt-2 flex-1 text-sm leading-6 text-sign-muted sm:mt-3">Learn computers, internet tools, software and practical digital tasks.</p>
                    <a href="{{ route('subjects.show', 'digital-skills') }}" class="mt-5 inline-flex min-h-11 items-center gap-2 text-sm font-semibold text-sign-primary sm:mt-6">
                ...
                <article class="group flex h-full flex-col rounded-2xl border border-sign-border bg-white p-5 transition duration-200 hover:-translate-y-1 hover:border-sign-cyan hover:shadow-lg sm:rounded-3xl sm:p-6">
                    ...
                    <h2 class="mt-4 font-heading text-xl font-semibold text-sign-primary sm:mt-5 sm:text-2xl">General Knowledge</h2>
                    <p class="mt-2 flex-1 text-sm leading-6 text-sign-muted sm:mt-3">Build useful knowledge about India, the world, society, places and everyday topics.</p>
                    <a href="{{ route('subjects.show', 'general-knowledge') }}" class="mt-5 inline-flex min-h-11 items-center gap-2 text-sm font-semibold text-sign-primary sm:mt-6">
                ...
                <article class="group flex h-full flex-col rounded-2xl border border-sign-border bg-white p-5 transition duration-200 hover:-translate-y-1 hover:border-sign-cyan hover:shadow-lg sm:rounded-3xl sm:p-6">
                    ...
                    <h2 class="mt-4 font-heading text-xl font-semibold text-sign-primary sm:mt-5 sm:text-2xl">Life Skills</h2>
                    <p class="mt-2 flex-1 text-sm leading-6 text-sign-muted sm:mt-3">Develop communication, confidence, organisation and practical everyday skills.</p>
                    <a href="{{ route('subjects.show', 'life-skills') }}" class="mt-5 inline-flex min-h-11 items-center gap-2 text-sm font-semibold text-sign-primary sm:mt-6">
                        Explore Life Skills
                        <span class="transition group-hover:translate-x-1">→</span>
                    </a>
                </article>
