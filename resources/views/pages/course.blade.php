...
@section('title', $currentLessonModel ? $currentLessonModel->title . ' - ' . $course['title'] . ' - SignGyaan' : $course['title'] . ' - SignGyaan')
@section('description', $currentLessonModel?->short_description ?: $course['description'])
            ...
            <x-container>
                ...
                <div class="mt-8 grid gap-4 sm:mt-10 md:grid-cols-3 md:gap-5">
                    ...
                    <div class="rounded-2xl border border-sign-border bg-white p-5 sm:rounded-3xl sm:p-6">
                        ...
                        <p class="mt-2 text-sm leading-6 text-sign-muted">Complete published practice activities and use supporting resources directly inside each lesson.</p>
                    </div>
                </div>
            </x-container>
        </section>
