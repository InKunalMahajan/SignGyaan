            ...
            <div class="mt-6 grid gap-7 sm:mt-8 xl:grid-cols-[minmax(0,1fr)_22rem] xl:items-start xl:gap-12">
                <div class="max-w-3xl">
                    <div class="flex flex-wrap items-center gap-2 sm:gap-3">
                        <span class="rounded-full bg-white px-3 py-1.5 text-xs font-semibold text-sign-primary shadow-sm ring-1 ring-sign-border sm:px-4 sm:py-2">
                            {{ $course['level'] }}
                        </span>
                        <span class="text-xs font-semibold uppercase tracking-wider text-sign-cyan-dark sm:text-sm">
                            {{ $subject['name'] }} Course
                        </span>
                    </div>

                    <h1 class="mt-4 font-heading text-3xl font-semibold leading-tight tracking-tight text-sign-primary sm:mt-5 sm:text-5xl lg:text-6xl">
                        {{ $course['title'] }}
                    </h1>
                    ...
                    <div class="mt-6 flex flex-col gap-3 sm:mt-8 sm:flex-row">
                        <a
                            ...
                            class="inline-flex min-h-11 w-full items-center justify-center rounded-xl bg-sign-primary px-6 py-3 text-sm font-semibold text-white transition hover:bg-sign-dark sm:w-auto"
                        >
                            Start Course
                        </a>
                        ...
                        <a
                            ...
                            class="inline-flex min-h-11 w-full items-center justify-center rounded-xl border border-sign-primary px-6 py-3 text-sm font-semibold text-sign-primary transition hover:bg-white sm:w-auto"
                        >
                ...
                <aside class="w-full rounded-2xl border border-sign-border bg-white p-5 shadow-sm sm:rounded-3xl sm:p-6" aria-label="Course summary">
                    <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-sign-light text-sm font-bold text-sign-primary sm:h-14 sm:w-14 sm:text-base">
                        {{ $subject['code'] }}
                    </div>
        ...
        <x-container>
            <div class="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:gap-12 xl:gap-14">
                <div>
                    ...
                    <p class="mt-4 max-w-xl text-sm leading-7 text-sign-muted sm:text-base">
    ...
    <section class="border-y border-sign-border bg-sign-soft py-10 sm:py-14 lg:py-20">
        <x-container>
            <div class="mx-auto max-w-3xl text-center">
                ...
                <p class="mt-4 text-sm leading-7 text-sign-muted sm:text-base">Each lesson can combine Indian Sign Language support, visual notes and short practice activities.</p>
            </div>
            ...
            <div class="mt-8 grid gap-4 sm:mt-10 md:grid-cols-3 md:gap-5">
                <div class="rounded-2xl border border-sign-border bg-white p-5 sm:rounded-3xl sm:p-6">
                    <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-sign-light text-sign-primary sm:h-12 sm:w-12">
    ...
    <section class="border-t border-sign-border bg-sign-soft py-10 sm:py-14 lg:py-20">
        <x-container>
            <div class="rounded-2xl bg-sign-dark px-5 py-8 text-white sm:rounded-3xl sm:px-10 sm:py-12 lg:flex lg:items-center lg:justify-between lg:gap-10">
                ...
                <a href="#course-curriculum" class="mt-6 inline-flex min-h-11 w-full items-center justify-center rounded-xl bg-white px-6 py-3 text-sm font-semibold text-sign-primary transition hover:bg-sign-soft sm:w-auto lg:mt-0">
                    View Lessons
                </a>
            </div>
        </x-container>
