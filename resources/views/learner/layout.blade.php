...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'SignGyaan learner workspace')">
    <title>@yield('title', 'Learner') | SignGyaan</title>
        ...
        <aside class="border-b border-slate-200 bg-white lg:min-h-screen lg:border-b-0 lg:border-r">
            ...
            <nav class="px-4 pb-5 lg:px-5" aria-label="Learner navigation">
                ...
                <div class="flex gap-2 overflow-x-auto pb-1 lg:flex-col lg:overflow-visible">
                    ...
                    <a href="{{ route('learner.progress.index') }}" class="flex min-w-fit items-center rounded-xl px-3 py-3 text-sm font-bold {{ request()->routeIs('learner.progress.*') ? 'bg-slate-950 text-white' : 'text-slate-700 hover:bg-slate-100' }}">Progress</a>
            ...
            <div class="mx-5 mb-5 hidden rounded-xl border border-slate-200 bg-slate-50 p-4 lg:block">
                ...
                <p class="mt-1 text-xs font-semibold text-slate-500">Learner</p>
